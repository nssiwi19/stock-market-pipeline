...
def main() -> None:
    ...
    heartbeat = out_dir / f"batchfull_fresh_safe_{run_id}.heartbeat.txt"
    result_file = out_dir / f"batchfull_fresh_safe_{run_id}.result.json"
    error_file = out_dir / f"batchfull_fresh_safe_{run_id}.error.txt"
    done_file = out_dir / f"batchfull_fresh_safe_{run_id}.done.txt"
