...
def main() -> None:
    ...
    heartbeat = out_dir / f"pilot100_balanced_{run_id}.heartbeat.txt"
    result_file = out_dir / f"pilot100_balanced_{run_id}.result.json"
    error_file = out_dir / f"pilot100_balanced_{run_id}.error.txt"
    done_file = out_dir / f"pilot100_balanced_{run_id}.done.txt"
    ...
    try:
        result = run_pilot(
            ...
            new_key_allowed_sources="vietstock_bctc_documents,vietstock_financeinfo,vci_financial_api",
